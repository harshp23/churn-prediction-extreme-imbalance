...
csv_files = [
    ...
    ('geolocation_dataset.csv','geolocation')  # Added payments.csv for specific handling
]
...
folder_path = r'C:\Users\harsh\OneDrive\Desktop\data analysis\Agentic AI-Powered Revenue & Churn Analytics on E-Commerce Data'
